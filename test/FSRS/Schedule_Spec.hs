...
spec = do
  ...
  describe "FSRS Scheduler reviews (hard coded values compared to Python implementation output)" $ do
    ...
    describe "New Card Updates" $ do
      let newCard' = NewCard 1 -- apostrophe since `newCard` is a function
      ...
      it "updates new cards reviewed with again" $ do
        ...
        reviewedCard `shouldBe` (ActiveCard $ CardDetails
          { cardId          = 1
          , cardState       = Learning
          , cardDue         = UTCTime (fromGregorian 2022 11 29) (1*60)
          , cardLastReview  = reviewTime
          , cardStep        = 0
          , cardLapses      = 0
          , cardRepetitions = 1
    ...
    describe "Learning Card Updates" $ do
      let reviewTime = UTCTime (fromGregorian 2022 11 29) (10*60)
          ...
          learningCard = ActiveCard $ CardDetails
            { cardId          = 2
            , cardState       = Learning
            , cardDue         = reviewTime
            , cardLastReview  = UTCTime (fromGregorian 2022 11 29) 0
            , cardStep        = 1
            , cardLapses      = 0
            , cardRepetitions = 1
            , cardStability   = 3.2602
      ...
      it "updates learning cards reviewed with Again, 5 minutes before due" $ do
        ...
        reviewedCard `shouldBe` (ActiveCard $ CardDetails
          ...
          , cardLastReview  = reviewTimeMinus5min
          , cardStep        = 0
          , cardLapses      = 0
          , cardRepetitions = 2
          , cardStability   = 0.7833819093752047
      ...
      it "updates learning cards reviewed with Again, 1 day after due" $ do
        ...
        reviewedCard `shouldBe` (ActiveCard $ CardDetails
          ...
          , cardLastReview  = reviewtimePlus1day
          , cardStep        = 0
          , cardLapses      = 0
          , cardRepetitions = 2
  ...
  describe "Reviewing Card Updates" $ do
    let reviewTime      = UTCTime (fromGregorian 2022 12 7) (10*60)
        reviewingCard = ActiveCard $ CardDetails
          { cardId          = 2
          , cardState       = Reviewing
          , cardDue         = reviewTime
          , cardLastReview  = UTCTime (fromGregorian 2022 11 29) (10*60)
          , cardStep        = 0
          , cardLapses      = 0
          , cardRepetitions = 2
  ...
  describe "Relearning Card Updates" $ do
    let reviewTime      = UTCTime (fromGregorian 2022 12  7) (20*60)
        relearningCard = ActiveCard $ CardDetails
          { cardId          = 2
          , cardState       = Relearning
          , cardDue         = UTCTime (fromGregorian 2022 12 7) (20*60)
          , cardLastReview  = UTCTime (fromGregorian 2022 12 7) (10*60)
          , cardStep        = 0
          , cardLapses      = 1
          , cardRepetitions = 3
    ...
    it "updates relearning cards reviewed with Again" $ do
    ...
    it "updates relearning cards reviewed with Hard" $ do
    ...
    it "updates relearning cards reviewed with Good" $ do
    ...
    it "updates relearning cards reviewed with Easy" $ do
